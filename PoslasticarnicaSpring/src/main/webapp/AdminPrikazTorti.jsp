...
<link rel="stylesheet" href="/LibraryWEB/views/style.css">
		...
		<tr>
			<c:forEach var="t" items="${torte }">
				<tr>
					...
					<td>${t.cena }</td>
					<td>${t.opis }</td>
					<td><a href="/Poslasticara/Torte/nadjiTortu?idTorta=${t.idTorta }">Prikazi</a></td>
					<td><a href="/Poslasticara/Torte/izbrisiTortu?idTorta=${t.idTorta }">Izbrisi</a></td>
