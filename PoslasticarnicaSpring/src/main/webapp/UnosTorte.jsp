...
<body>
	...
	<div id="sadrzaj">
		<div class="kontejner">
			<h2>Unos torte</h2>
			<form:form modelAttribute="tortaI"
				action="/Poslasticara/Torte/saveTortaSlika" method="post"
				...
				<br>
				Cena <br>
				<form:input type="text" name="cene" path="cena" />
				<br>
				<br>
				Opis<br>
				<form:input type="textarea" name="opis" path="opis" />
				<br>
				<br>
				Slika <form:input type="file" path="slika" />
				<br>
				<br>
